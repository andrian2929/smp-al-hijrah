...
<h1 style="margin-left: 30px">Laporan Harian Siswa</h1>
  <a-row type="flex" justify="center">
    <a-col :xs="23">
      <a-card :loading="loading" title="Pilih Kriteria" style="width: 100%; margin-bottom: 20px">
        <a-space
        ...
        <a-space
          ...
          >
            <a-button type="primary" style="display: inline-flex; align-items: center;">
                <template #icon><SearchOutlined /></template>
                Cari
            </a-button>
        </a-space>
      </a-card>
      <a-card :loading="loading" title="Daftar Siswa" style="width: 100%">
        <a-space
          direction="horizontal"
  ...
  <!-- modal bagian tahfidz -->
   <a-modal v-model:visible="showModal1" title="Posting Laporan Tahfidz" @ok="showModal1 = false">
      <a-select
    ...
    <a-modal v-model:visible="showModal2" title="Posting Mutaba'ah Ibadah" @ok="showModal2 = false">
      <a-date-picker
            v-model:value="filter.tanggal"
            style="width: 345px"
            placeholder="Tanggal Posting"
          />
      <a-table :dataSource="dataSource1" :columns="kolom1" :scroll="{ y: 300 }" :pagination="false">
        <template #bodyCell="{ column, record }">
    ...
    <a-modal v-model:visible="showModal3" title="Posting Laporan Perilaku Harian Siswa" @ok="showModal3 = false" width="1000px">
      <a-date-picker
            v-model:value="filter.tanggal"
          ...
          /> 
          <!-- perilaku terpuji  -->
      <a-table :dataSource="dataSource3" :columns="kolom3" :scroll="{ y: 300 }" :pagination="false" style="margin-bottom: 6px" bordered>
        <template #bodyCell="{ column, record }">
      ...
      <a-table :dataSource="dataSource4" :columns="kolom4" :scroll="{ y: 300 }" :pagination="false" bordered>
        <template #bodyCell="{ column, record }">
