...
class ListPerilakuSeeder extends Seeder
{
    ...
    public function run()
    {
        $data = [
            ...
            ['name' => 'Mendamaikan teman yang berselisih', 'type' => 'akhlak', 'is_terpuji' => 1],
            ['name' => 'Menjadi Tentor Sebaya ketika Belajar', 'type' => 'akhlak', 'is_terpuji' => 1],
            ['name' => 'Merapikan Sandal dan sepatu', 'type' => 'akhlak', 'is_terpuji' => 1],
            ['name' => 'Membawa Jimat (Benda yang dianggap bisa menolong)', 'type' => 'aqidah', 'is_terpuji' => 0],
            ['name' => 'Membawa Buku-buku Zodiak', 'type' => 'aqidah', 'is_terpuji' => 0],
