                ...
                >
                    <template #bodyCell="{ column, record }">
                        ...
                        <template v-else-if="column.key === 'kegiatan'">
                            ...
                            >
                                <a-row>
                                    <a-col :span="8">
                                        <a-checkbox :value="1"
                                            >Qiyamul Lail</a-checkbox
                                        >
                                    </a-col>
                                    <a-col :span="8">
                                        <a-checkbox :value="2"
                                            >Tilawah Qur'an</a-checkbox
                                        >
                                    </a-col>
                                    <a-col :span="8">
                                        <a-checkbox :value="3"
                                    ...
                                    <a-col :span="8">
                                        <a-checkbox :value="4"
                                            >Puasa Sunnah</a-checkbox
                                        >
                                    </a-col>
                                    <a-col :span="8">
                                        <a-checkbox :value="5"
                                            >Sholat Dhuha</a-checkbox
                                        >
                                    </a-col>
                                    <a-col :span="8">
                                        <a-checkbox :value="6"
                                            >Membaca Buku</a-checkbox
                                        >
                                    </a-col>
                                    <a-col :span="8">
                                        <a-checkbox :value="7"
                                            >Al-Matsurat</a-checkbox
                                        >
                                    </a-col>
                                </a-row>
                            </a-checkbox-group>
                        ...
                        <template v-else-if="column.key === 'action'">
                            ...
                            >
                            <a-button type="button" @click="showModal3 = true"
